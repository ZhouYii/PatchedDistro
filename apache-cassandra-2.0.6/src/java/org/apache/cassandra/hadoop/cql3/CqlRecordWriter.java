...
final class CqlRecordWriter extends AbstractColumnFamilyRecordWriter<Map<String, ByteBuffer>, List<ByteBuffer>>
{
	...
	String formatted = "SELECT key_validator, key_aliases,column_aliases FROM system.schema_columnfamilies WHERE keyspace_name='cql3_worldcount' and columnfamily_name='output_words'";
